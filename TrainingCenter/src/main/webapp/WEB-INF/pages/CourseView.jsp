  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <p><h1>${courselist}</h1></p>
				...
				<view:forEach var="cou" items="${courseList}">
						<tr>
							<td>${cou.getCourseId()}</td>
							<td>${cou.getCourseName()}</td>
							<td>${cou.getCourseDescription()}</td>
							<td>${cou.getFees()}</td>
							<td><a href='edit/${cou.getCourseId()}'> Edit</a>
							<a href='delete/${cou.getCourseId()}'> Delete</a></td>
						</tr>
					</view:forEach>		
				</table>
			</div>
